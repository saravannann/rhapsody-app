...
import { User, LogOut, Settings, ChevronDown, LayoutDashboard, Ticket, BarChart2 } from "lucide-react";
          ...
          <div className="flex items-center h-16 gap-6">
            ...
            <Link href="/organiser-dashboard" className="flex items-center gap-2.5 shrink-0">
              ...
              <div className="flex flex-col leading-none">
                ...
                <span className="text-[9px] text-accent font-bold uppercase tracking-widest">Organiser Portal</span>
              </div>
            </Link>
