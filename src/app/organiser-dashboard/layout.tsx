          ...
          <div className="flex items-center h-14 sm:h-16 gap-2 sm:gap-6">
            ...
            <Link href="/organiser-dashboard" className="flex items-center gap-2 sm:gap-2.5 shrink-0 min-w-0 max-w-[min(100%,22rem)]">
              ...
              <div className="flex flex-col leading-tight min-w-0">
                ...
                <span className="text-[9px] sm:text-[10px] text-accent font-bold uppercase tracking-wider sm:tracking-widest whitespace-normal dark:text-amber-400/90">Organiser Portal</span>
              </div>
            </Link>
        ...
        <div className="md:hidden fixed inset-0 z-50" role="dialog" aria-modal="true" aria-labelledby="organiser-mobile-nav-title">
          ...
          >
            <div className="flex items-center justify-between px-4 h-14 border-b border-[var(--border-subtle)] bg-[var(--muted-bg)]">
              <p id="organiser-mobile-nav-title" className="text-sm font-bold text-[var(--foreground)]">
                Menu
              </p>
              <button
                type="button"
